...
function FPDF($orientation='P',$unit='mm',$format='A4')
{
	...
	$this->ws=0;
	//Standard fonts
	$this->CoreFonts=array('GB'=>'GB','GB'=>'GB-Bold','courier'=>'Courier','courierB'=>'Courier-Bold','courierI'=>'Courier-Oblique','courierBI'=>'Courier-BoldOblique',
...
function AddFont($family,$style='',$file='')
{
	...
	if($family=='simsun') $family='helvetica';
