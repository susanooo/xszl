...
OBS6: Optimized to 'A4' paper (default font: simsun , normal , size 11 )
...
//! @desc Prepares buffered text to be printed with FlowingBlock()
    ...
    for($i=0;$i < $array_size; $i++)
    {
      ...
      if(isset($vetor[4]) and $vetor[4] != '') $this->SetFont('GB');
